...
Este libro es acerca de darle instrucciones a las ((computadora))s. Las
computadoras son tan comunes como los destornilladores hoy en día, pero
son mucho más complicadas, y lograr que hagan lo que quieres que hagan
no es fácil siempre.

Si la tarea que tienes para tu computadora es común y ha sido bien entendida,
como mostrarte el email o funcionar como calculadora, puedes abrir
la ((aplicación)) apropiada y ponerte a trabajar. Pero para tareas
únicas y que no están completamente definidas, probablemente no hay una
aplicación.

Ahí es donde la ((programación)) entra. _Programar_ es el acto de construir
un _programa_: un conjunto de instrucciones precisas que le dicen a una
computadora qué hacer. Debido a que las computadoras son tontas, bestias
pedantes, programar es fundamentalmente tedioso y frustrante.

{{index [programación, "alegría de"], velocidad}}

Afortunadamente, si puedes superar este hecho y si tal vez puedes disfrutar
el rigor de pensar en términos que máquinas tontas puedan tratar, programar
puede ser remunerador. Permite hacer cosas en segundos que tomarían _una eternidad_
a mano. Es una manera de hacer que tu computadora-herramienta haga cosas
que antes no podía. Y es un excelente ejercicio en pensamiento abstracto.

La mayor parte de la programación se hace con ((lenguajes de programación)). Un
_lenguaje de programación_ es un lenguaje construido artificialmente usado para
darle instrucciones a las computadoras. Es interesante que la forma más efectiva
que hemos encontrado para comunicarnos con una computadora tome tantas
cosas de la forma en que nos comunicamos con los demás. Como los lenguajes
humanos, los lenguajes de computadora permiten que palabras y frases 
sean combinadas en nuevas formas, haciendo posible expresar conceptos 
nunca antes expresados.

{{index [JavaScript, "availability of"], "casual computing"}}

En cierto punto las interfaces basadas en lenguajes, como las líneas
de comando de BASIC y DOS de los ocehntas y noventas, fueron el método
principal para interactuar con las computadoras.
