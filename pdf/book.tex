...
\frontmatter
  ...
  \noindent Copyright \textcopyright{} 2018 por Marijn Haverbeke

  \vskip 1em

  \noindent Este libro está bajo la licencia Creative Commons
  Atribución-NoComercial 3.0
  (\url{http://creativecommons.org/licenses/by-nc/3.0/}). El código también
  puede considerarse bajo una licencia MIT
  (\url{http://opensource.org/licenses/MIT}).

  Las ilustraciones han sido contribuidas por varios artistas: Cover and
